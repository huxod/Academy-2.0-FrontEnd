...
import { Segment, List, Header, Icon, ListItem, Button, Divider, Table } from 'semantic-ui-react';
      ...
      <Segment>
        ...
        <List>
          ...
          <Table celled>
            <Table.Header>
              <Table.Row>
                <Table.HeaderCell colSpan='3'>User role:</Table.HeaderCell>
              </Table.Row>
            </Table.Header>
            <Table.Body>
              <Table.Row>
                {Cookies.getJSON('userRole').map((ele: any, i: any) =>  <Table.Cell key={i}>{ele.role}</Table.Cell>)}
              </Table.Row>
            </Table.Body>
          </Table>
          <Divider />
